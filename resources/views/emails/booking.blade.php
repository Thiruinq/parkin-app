...
<html lang="en">
   ...
   <body style="font-family: Arial, sans-serif; background-color: #e9ecef;">
                        ...
                        <tr>
                           <td align="left" bgcolor="#ffffff" style="padding:0 24px 24px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                              <p style="margin: 0 0 15px;">
                                 Thank you for booking your car parking space with us! Your reservation is confirmed, and we're here to assist you with any further needs.
                              </p>
